...
# ИСПРАВЛЕННЫЙ ИМПОРТ: Импортируем HarmCategory из types
from google.genai.types import HarmCategory, SafetySetting, HarmBlockThreshold 
...
SAFETY_SETTINGS = [
    ...
    for category in [
        # Теперь HarmCategory.HARM_CATEGORY_HARASSMENT будет найдено корректно
